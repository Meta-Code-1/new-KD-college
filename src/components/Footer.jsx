  ...
  return (
    <footer className="relative bg-royal-navy text-white pt-32 pb-12 overflow-hidden font-sans">
      ...
      <div className="container mx-auto px-6 relative z-20">
        ...
        <div className="bg-white/5 backdrop-blur-xl rounded-2xl p-8 md:p-12 border border-white/10 mb-20 flex flex-col md:flex-row items-center justify-between gap-8 shadow-2xl relative overflow-hidden group">
